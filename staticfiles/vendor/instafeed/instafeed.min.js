        ...
        (t.prototype._showNext = function (e) {
            ...
            if ((t._debug("showNext", "pool", t._state.pool.length, t._state.pool), t._state.pool.length > 0)) {
                ...
                t._state.paging && "string" == typeof t._state.paging.next
                    ...
                    : ((o = "https://graph.instagram.com/me/media?fields=caption,id,media_type,media_url,permalink,thumbnail_url,timestamp,username&access_token=" + t._state.token),
                      t._options.apiLimit || "number" != typeof t._options.limit
                          ? "number" == typeof t._options.apiLimit && (t._debug("showNext", "apiLimit set, overriding limit", t._options.apiLimit, t._options.limit), (o = o + "&limit=" + t._options.apiLimit))
                          : (t._debug("showNext", "no apiLimit set, falling back to limit", t._options.apiLimit, t._options.limit), (o = o + "&limit=" + t._options.limit))),
        ...
        (t.prototype._processData = function (e) {
            ...
            return (
                i &&
                    ...
                    r > 0 && ((p = s.slice(s.length - r)), this._debug("processData", "unusedItems", p.length, p), s.splice(s.length - r, r))),
                { items: s, unused: p }
            );
        }),
